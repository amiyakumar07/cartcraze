    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CartCrazeTheme {
                ...
                val authViewModel: com.example.ui.viewmodel.AuthViewModel = viewModel(factory = viewModelFactory)
                val locationStoreViewModel: com.example.ui.viewmodel.LocationStoreViewModel = viewModel(factory = viewModelFactory)
...
fun CartCrazeApp(
    ...
    locationStoreViewModel: com.example.ui.viewmodel.LocationStoreViewModel
) {
    ...
    val isTopLevelDestination = currentRoute in listOf("home", "categories", "offers", "cart", "orders", "account")
