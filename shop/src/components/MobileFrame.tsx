  ...
  return (
    <div className="min-h-screen bg-[#111827] flex items-center justify-center sm:py-8 font-sans">
      ...
      >
        ...
        <div className="hidden sm:flex items-center justify-between px-6 pt-3 pb-1 bg-[#f9f9f9] shrink-0 z-50 relative">
        ...
        {/* Home indicator */}
        <div className="hidden sm:flex justify-center pb-2 pt-1 bg-[#f9f9f9] shrink-0">
